...
The following assumptions are used in this document.
 ...
 - the user is or has deployed the example two node Stroom cluster storage hierarchy described [here]({{< relref "install-how-to.md#storage-scenario" >}})
...
- Node: `stroomp02.strmdev00.org`
  ...
  * Install NFS software as [above]({{< relref "install-nfs-how-to.md#installation-of-nfs-software" >}})
