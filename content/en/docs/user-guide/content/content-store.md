...
The content within a Content Pack has full access to your Stroom system.
You should examine the content carefully before trusting it.
...
A new {{< stroom-icon "document/GitRepo.svg" >}} Git Repo document will be created in the Explorer Tree and content pulled from Git.

Some Content Packs might be marked as requiring authentication.
In this case you will need to contact the provider of the Content Pack for credentials.
...
The Content Store will check whether updates are available in the background.
...
Any available changes to the content within the Git Repository will be shown in {{< external-link "diff format" "https://en.wikipedia.org/wiki/Diff#Context_format" >}}.
