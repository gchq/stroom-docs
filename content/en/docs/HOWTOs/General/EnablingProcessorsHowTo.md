...
Keep the term and operator at the default settings, and select the **Choose item** {{< stroom-icon "popup.png" "Select Feed">}} icon to navigate to the desired feed name (_Apache-SSLBlackBox-V2.0-EVENT_) object
