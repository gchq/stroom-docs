...
One software based solution would be to install the [haveged (external link)](https://github.com/jirka-h/haveged "Haveged Web Site") service that attempts to provide an easy-to-use, unpredictable random number generator based upon an adaptation of the HAVEGE algorithm.
To install execute
```bash
