...
Hugo includes many {{< external-link "shortcodes" "https://gohugo.io/content-management/shortcodes/" >}}, the Docsy theme adds some {{< external-link "more" "https://www.docsy.dev/docs/content/shortcodes/" >}} and there are some bespoke _stroom-docs_ ones in `layouts/shortcodes/`.
