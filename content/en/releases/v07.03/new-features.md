...
In v7.2 of Stroom, the ability to use API Keys was removed if you were using an external {{< glossary "idp">}} as client systems could get tokens from the IDP themselves.
