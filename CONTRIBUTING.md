...
When submitting a pull request (PR) the following rules should be observed:
...
1. Commit the changes following the commit message standards above.
...
See the [Style Guide](https://gchq.github.io/stroom-docs/community/documentation/style-guide/) for details of the conventions used in the documentation.


### Building the Documentation Site

For details of how to build the documentation site, see [here](https://gchq.github.io/stroom-docs/community/documentation/).
