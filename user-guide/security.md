...
It is beyond the scope of this article to discuss this in detail but all MySQL accounts should be secured on initial install. Official guidance for doing this can be found [here](http://dev.mysql.com/doc/refman/5.6/en/default-privileges.html).
...
* Making MySQL and the application communicate over SSL (see [here](http://dev.mysql.com/doc/refman/5.6/en/secure-connections.html) for instructions)
